...
export const environment: IDocAppEnvironment = {
  ...
  mdFilePaths: ['libs/client-core-components/README.md', 'libs/client-services/README.md', 'libs/client-translate/README.md', 'libs/client-diagnostics/README.md', 'tools/ts/README.md', 'tools/shell/README.md', 'libs/client-core/README.md', 'libs/client-user/README.md', 'libs/backend-auth/README.md', 'libs/backend-interfaces/README.md', 'libs/backend-grpc/README.md', 'libs/client-util/README.md', 'libs/client-unit-testing/README.md', 'libs/client-material/README.md', 'libs/client-pipes/README.md', 'tools/ts/UNIT_COVERAGE.md', 'libs/proto/README.md', 'libs/client-chatbot/README.md', 'libs/backend-diagnostics/README.md', 'libs/client-sidebar/README.md', 'libs/client-workspaces/README.md', 'libs/client-directives/README.md', 'libs/backend-websocket/README.md', 'libs/client-store/README.md', 'libs/backend-logger/README.md', 'tools/README.md'],
};
