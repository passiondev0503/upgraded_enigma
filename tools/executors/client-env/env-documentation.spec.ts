...
describe('AppDocumentationEnvConfig', () => {
  const setup = (
    app: TSupportedApp = 'documentation',
    mockAccess?: boolean,
  ...
  describe('errors', () => {
    ...
    it('should throw an error if an application is not supported', async () => {
      ...
      const executor = new AppDocumentationEnvConfig(options, context);
      executor.supportedApps.shift(); // remove 'documentation' from the supported apps array to make it unsupported
    ...
    it('should throw an error if unable to access environment config file', async () => {
      ...
      const { context, options, accessMock, readFileMock, writeFileMock } = setup('documentation', false, true);
    ...
    it('should throw an error if unable to stat env file path', async () => {
      ...
      const { context, options, accessMock, readFileMock, statMock, writeFileMock } = setup('documentation', true, true);
      statMock.mockImplementation(
        (
          path: PathLike,
          opts?: StatOptions & {
    ...
    it('should throw an error if unable to write env file', async () => {
      ...
      const { context, options, accessMock, readFileMock, statMock, writeFileMock } = setup('documentation', true, true, true);
      writeFileMock.mockImplementation(
        (
          file: PathLike | fsPromises.FileHandle,
          data:
  ...
  describe('correct behavior', () => {
    ...
    it('should call logger.info if everything went as expected when setting environment variables', async () => {
      ...
      const { context, options, accessMock, readFileMock, statMock, writeFileMock } = setup('documentation', true, true, true, true);
      const executor = new AppDocumentationEnvConfig(options, context);
